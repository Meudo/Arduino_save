...
class NeoPatterns : public Adafruit_NeoPixel
{
    ...
    {
        WheelPos = 255 - WheelPos;
        if(WheelPos < 85) { return Color(255 - WheelPos * 3, 0, 0); }
        else if(WheelPos < 170)
        {
            WheelPos -= 85;
            return Color(0, WheelPos * 3, 03);
        }
        else
        {
            WheelPos -= 170;
            return Color(WheelPos * 3, WheelPos * 3, WheelPos * 3);
        }
    }
};
...
NeoPatterns Stick6(150, 11, NEO_GRB + NEO_KHZ800, &Stick6Complete); // Sapin 150

// Initialize everything and prepare to start *****************************************************************************************
void setup()
{
    pattern KickOffPatern = SCINTILLE; //NONE, XMAS_RAINBOW_CYCLE, RAINBOW_CYCLE, THEATER_CHASE, COLOR_WIPE, SCANNER, FADE, SCINTILLE
    Serial.begin(115200);
...
void Stick1Complete()
{
    if (NbIteration++ < 6)
    {
      switch (CurrentColor)
      {
        ...
        case 1: /*red*/   Stick1.Fade(Stick1.Color2, Stick1.Color(255,0,0),     255, 1); break;
        case 2: /*green*/ Stick1.Fade(Stick1.Color2, Stick1.Color(0,255,0),     255, 1); break;
        case 3: /*white*/ Stick1.Fade(Stick1.Color2, Stick1.Color(255,255,255), 255, 1); break;
      }
