...
NeoPatterns Stick1(150, 6, NEO_GRB + NEO_KHZ800, &Stick1Complete);
NeoPatterns Stick2(150, 7, NEO_GRB + NEO_KHZ800, &Stick2Complete);
...
void setup()
{
  Serial.begin(115200);
   ...
   //pinMode(2, INPUT_PULLUP); INPUT : High if Alim powered-up
    ...
    Stick2.Scanner(Stick2.Color(0,255,0), 1);
    //Stick.TheaterChase(Ring1.Color(255,255,0), Ring1.Color(0,0,50), 100);
